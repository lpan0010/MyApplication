...
public class SQLHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('90162800', 15, 3.50, 'Red Bull Sugarfree', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('90162602', 17, 3.50, 'Red Bull', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9348372157405', 12, 0.70, 'Coles Bag', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9300650025479', 25, 4.00, 'Oreos', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9310072028903', 22, 3.00, 'Shapes', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9310331000442', 30, 1.50, 'Sprinkles', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9300601977321', 18, 1.00, 'Plastic Cups', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9300601977352', 10, 1.50, 'Paper Plates', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.execSQL("INSERT INTO " + TABLE_ITEM + "(COLUMN_ITEMID, COLUMN_ITEMCO2, COLUMN_ITEMPRICE, COLUMN_ITEMNAME, COLUMN_ITEMTYPEID) VALUES ('9315596002767', 30, 3.50, 'SOLO', (SELECT COLUMN_TYPEID FROM TABLE_TYPE WHERE ) )");
        db.close();
    }
